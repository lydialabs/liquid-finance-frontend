...
export function theme(): DefaultTheme {
  return {
    colors: {
      ...
      // backgrounds
      bg1: "linear-gradient(125deg,rgb(164,232,234,1) 8%,rgba(153,195,239,0.9) 21%,rgba(224,233,239,0.7) 75%) no-repeat;",
      ...
      primaryBright: "rgba(220, 76, 26, 1)",
...
export const Typography = React.forwardRef(
  (props: TextProps & { variant?: TypographyVariant }, ref) => {
    ...
    switch (variant) {
      ...
      case "p":
        return <Text ref={ref} as="p" color="text3" fontSize={16} {...rest} />;
      case "label":
...
/* Risk */
  ...
  .scrollbar-primary {
    scrollbar-color: #1a334d rgba(255, 255, 255, 1);
  }
